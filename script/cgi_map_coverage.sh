...
bam_dir=${project_dir}/analysis/fig_factory/fig/Fig5/cgi/downsampled_bam_chr1_22
outdir=${project_dir}/analysis/fig_factory/fig/Fig5/cgi/coverage_bins
mkdir -p ${outdir}
...
bam=${bam_dir}/${sample}.chr1_22.depthEligible.downsampled.bam
...
# samtools depth gives 1-based POS.
# Convert to 0-based 1-bp bedGraph:
# chrom  POS-1  POS  depth
samtools depth \
  -aa \
  -b ${bins} \
  -Q 0 \
...
# Map all-base depth to each CGI profile bin.
bedtools map \
  -a ${bins} \
  -b ${depth_bg} \
  -c 4 \
